...
Building requires a C++ compiler (already present via `build-essential` / Xcode CLT / VS Build Tools) because the XMP writer vendors Adobe's XMP Toolkit and compiles it from source. No other system libraries are required.
